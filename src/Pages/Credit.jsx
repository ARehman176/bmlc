        ...
        <div className="flex  bg-[#F8F6FC] min-h-screen">
            ...
            <div className="flex-1 p-6">
                ...
                <div className="flex justify-between items-center w-full mb-6">
                    <h1 className="text-2xl font-bold text-[#27272A]">Credit History</h1>
                ...
                <div className="bg-white rounded-xl shadow-md p-6 w-fit " >
                    <div className="bg-gradient-to-bl from-[#9363C340] via-white to-[#9363C430] w-[355px] h-[200px] rounded-xl shadow-md p-6  max-w-md mb-2 ">
                        ...
                        <div className="space-y-1">
                            <div>
                                ...
                                <h3 className="text-2xl font-bold text-[#9363C4]">$120.00</h3>
                            </div>
                    ...
                    <div className="flex justify-center gap-4 mt-6">
                        <button className="flex items-center gap-2 border border-[#9363C488] px-4 py-2 rounded-lg text-sm
                         font-medium text-[#9363C4] 
                          ">
                            <Icon icon="solar:card-outline" className="text-lg" />
                            Manage Card
                        </button>
                        <button className="flex items-center gap-2 bg-[#C8B8E8] 
                          text-sm px-4 py-2 rounded-lg font-medium text-[#27272A]
                       ]">
                    ...
                    <div className="flex flex-row justify-between items-center mt-4 px-4">
                        ...
                        <div className="flex items-center  gap-2 text-gray-600">
                            <button className="hover:text-gray-800">
                                <Icon icon="line-md:arrow-left" className="w-5 h-5" />
                            </button>
                            <button className="hover:text-gray-800">
                                <Icon icon="line-md:arrow-right" className="w-5 h-5" />
                            </button>
                        </div>
                    </div>
                </div>
