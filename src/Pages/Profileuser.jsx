        ...
        <div className="flex bg-[#F8F6FC] min-h-screen">
            ...
            <div className="flex-1 p-6 flex flex-col ">
                ...
                <div className="flex justify-between items-center w-full mb-10">
                    <h1 className="text-2xl font-semibold text-[#27272A]">Profile</h1>
                    <div className="flex items-center gap-3 hover:scale-105 transition duration-200 ease-in-out">
                        ...
                        <div className="text-left text-sm text-gray-700">
                            ...
                            <div className="text-[#7F7F7F] text-xs">johndoe516@</div>
                        </div>
                    </div>
                </div>
                ...
                <div className="relative z-10 flex justify-center -mt-38 " >
                    <div className="relative w-32 h-32">
                        <img
                            src={Avatar}
                            alt="User"
                            className="w-full h-full object-cover rounded-full border-2 border-dotted  p-1 border-[#C8B8E8]  shadow-lg"
                        />
                        <button className="absolute bottom-0 right-0 bg-[#BBA5E0] p-1 rounded-full shadow">
                            <Icon icon="fluent:camera-28-regular" className="text-gray-600 text-lg" />
                        </button>
                       <p className="text-2xl font-semibold  text-center text-[#374151] whitespace-nowrap">Emma Watson</p>
                ...
                <div className="bg-white shadow rounded-2xl p-6 w-full max-w-5xl mx-auto mt-2 mb-5">
                    <h1 className="text-xl font-semibold mb-6 mt-12">Personal Information</h1>
                ...
                {/* Action Buttons */}
                <div className="flex flex-row justify-between rounded-xl p-4 w-full max-w-5xl mx-auto mb-5">
