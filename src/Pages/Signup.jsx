              ...
              <ul className="text-xs mt-2 space-y-1">
                <li className="flex items-center gap-2">
                  <Icon
                    icon={
                      requirements.length
                        ? "qlementine-icons:check-tick-16"
                ...
                <li className="flex items-center gap-2">
                  <Icon
                    ...
                    className={`w-4 h-4 ${
                      requirements.upper ? "text-green-500" : "text-red-500"
                    }`}
                  />
               <span className={` ${
                      requirements.upper ? "text-green-500" : "text-red-500"
                ...
                <li className="flex items-center gap-2">
                  <Icon
                    ...
                    className={`w-4 h-4 ${
                      requirements.lower ? "text-green-500" : "text-red-500"
                    }`}
                  />
                 <span className={` ${
                      requirements.lower ? "text-green-500" : "text-red-500"
                  ...
                  <Icon
                    icon={
                      requirements.special
                        ? "qlementine-icons:check-tick-16A"
                        : "oui:cross-in-circle-empty"
                    }
                    className={`w-4 h-4 ${
