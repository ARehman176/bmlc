  ...
  return (
    <div className="flex gap-60 justify-center  bg-purple-200">
      <div className="mb-20 mt-20">
        ...
        <p className="mt-5 ml-4 "> Privacy Policy</p>
        <p className="ml-4 mt-4"> Terms of Service</p>
      </div>
      <div className="mt-20">
        ...
        <ul className="mt-13 mb-10">
          ...
          <li className="mt-3"> <Link to= '/price'>Pricing </Link></li>
          <li className="mt-3"> <Link to= '/Coaches'>Life Coaches</Link></li>
            <li className="mt-3"><Link to= '/Contact'>Contact Us</Link></li>
        </ul>
      </div>
      <div className="mt-20">
        <h3 className="font-semibold text-lg">Follow us on Social</h3>
