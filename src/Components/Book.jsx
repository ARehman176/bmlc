    ...
    <section className="bg-[#F8F6FC] py-16 px-4 md:px-24 mt-20">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row  gap-72">
        ...
        <div className="max-w-xl ml-20">
          <h2 className="text-3xl font-semibold text-gray-600 mb-4 mt-10">
            Get Our ebook:
            <br />
            "Finding Clarity in Chaos"
          </h2>
          <p className="text-gray-500 font-medium mb-4 mt-8 ">
          ...
          <p className="text-purple-400 font-semibold mb-6 mt-6">Only $4.99</p>
          <button
